...
--luacheck: globals font parameters source sourceless stateicons
...
function initDisplay()
	...
	local nOptionWidth = self.getOptionWidth();
	for k,_ in ipairs(_tValues) do
