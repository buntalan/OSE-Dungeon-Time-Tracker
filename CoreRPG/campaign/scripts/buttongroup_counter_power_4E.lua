...
function onInit()
	...
	DB.addHandler(DB.getPath(node, "prepared"), "onUpdate", self.update);
	DB.addHandler(DB.getPath(node, "used"), "onUpdate", self.update);
	self.updateSlots();
end
function onClose()
	local node = window.getDatabaseNode();
	DB.removeHandler(DB.getPath(node, "prepared"), "onUpdate", self.update);
	DB.removeHandler(DB.getPath(node, "used"), "onUpdate", self.update);
end
