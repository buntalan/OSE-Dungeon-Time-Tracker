...
function displayImperialDate(_, nYear, nMonth, nDay, bAddWeekDay, bShortOutput)
...
function displayImperiumDate(sEpoch, nYear, nMonth, nDay, _, bShortOutput)
...
function displayImperiumHourPhase()
